...
public class PrintWindow extends JFrame {
  ...
  public PrintWindow() {
    ...
    pnlPagePrint.setLayout(new MigLayout(
        "center, fill, insets 0 20 0 20")); // up, left, down, right
    ...
    lblSchoolName.setFont(new Font(Constants.FONT_FAMILY, Font.BOLD, 18));

    lblTitlePrint = new JLabel("REPORT OVERVIEW");
    lblTitlePrint.setFont(new Font(Constants.FONT_FAMILY, Font.BOLD, 25));
  ...
  public void values(JFreeChart chart, JFreeChart chartTrb, JFreeChart chartPhy,
                     JFreeChart chartSer, JFreeChart chartPer) {
